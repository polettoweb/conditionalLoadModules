function jcarouselFunc(){

var MgResponsive = MgResponsive || {};
console.log('Test from jcarousel module');
MgResponsive.uiCarousel = (function ($, Modernizr) {
    "use strict";
    return {
        init: function () {
            var jcarousel = $('.ui-carousel--responsive .jcarousel');
